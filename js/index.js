            ...
            case 'IcosahedronGeometry':
                ...
                if (currentcolor == 0x26D7E7) {
                    if (planetViewed == 1 || planetViewed==3 || planetViewed==4) {
                        planetViewed = 2;
                        info.innerHTML = '<span id="couleur">Codepen</span> Projects ';
                        document.getElementById('couleur').style.color="#26D7E7";
                        subtitle.innerHTML = "Since <span>February 2017</span>.";
                        description.innerHTML = "You can find all my experiments here :  <br/><a target='_blank' href='https://codepen.io/nikita_ska'>my Codepen</a><br/><br/><div>Click on the other planets to learn more ...<div>";
                   ...
                   if (currentcolor == 0xffc12d) {
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==4) {
                        planetViewed = 3;
                        info.innerHTML = '<span id="couleur">Study</span> Project : <a target="_blank" href="http://victoretlespalus.fr" style="font-size: 22px; color: white;">Victor et les Palus<a> ';
